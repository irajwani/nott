...
class PictureAddButton extends Component {
  constructor(props) {
    super(props);
  ...
  launchCamera() {
    ...
    this.props.navigation.navigate('PictureCamera')
    //<MyCustomCamera />
    ...
    return (
      <View>
        <Icon.Button name='plus' onPress={() => this.showActionSheet() }>
          <Text>Add/Change Profile Picture</Text>
        </Icon.Button>
...
export default withNavigation(PictureAddButton)