...
class MyCustomCamera extends Component {
  ...
  takePicture() {
    ...
    this.camera.takePictureAsync(options).then((image64) => {
        ...
        this.props.navigation.navigate('CreateItem' , {uri: this.state.pictureuri, base64: this.state.picturebase64, width: this.state.pictureWidth, height: this.state.pictureHeight})
